...
# # Объект, в котором аккумулируется информация о таблицах и используется в доальнешем, например при миграции
# metadata = MetaData()
# # class Book(Base):
# #     __tablename__ = 'book'
...
# # Documentation
# # Первый способ объявления таблицы
# documentation = Table(
#     "documentation",
#     Base.metadata,
...
# # Второй способ объявления таблицы
